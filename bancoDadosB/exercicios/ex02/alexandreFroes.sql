...
-- a)Listar o nome, nickname e pontuação de todos os jogadores que possuem
-- email gmail.
...
select * from partida
where hour(data_hora_inicio) >= 18;

-- c) Listar os dados dos jogadores que tem pontuação e quantidade de moedas
-- acima de 1000.

select * from jogador
where moedas > 1000 and pontuacao > 1000;
...
select nome, nickname from jogador
where pontuacao >= 2500;

-- e)Listar os dados de todos os poderes que tenham presente na habilidade a
-- palavra trovão ou elétrica.
